...
namespace projectSync_back.Migrations
{
    ...
    [Migration("20250502170024_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projectSync_back.Models.DepJuryMember", b =>
                {
                    ...
                    b.HasKey("DepartmentId", "JuryMemberId");

                    b.HasIndex("JuryMemberId");

                    b.ToTable("DepJuryMembers");
                });
            ...
            modelBuilder.Entity("projectSync_back.Models.JuryMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("projectSync_back.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("projectSync_back.Models.DepJuryMember", b =>
                {
                    b.HasOne("projectSync_back.Models.Department", "Department")
                        .WithMany("DepJuryMembers")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("projectSync_back.Models.JuryMember", "JuryMember")
                        .WithMany("DepJuryMembers")
            ...
            modelBuilder.Entity("projectSync_back.Models.Report", b =>
                {
                    ...
                    b.HasOne("projectSync_back.Models.Project", "Project")
                        .WithOne("Report")
                        .HasForeignKey("projectSync_back.Models.Report", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
